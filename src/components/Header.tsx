...
export function Header({ onImportPhotos, onOpenStatistics, onOpenExport, onOpenSearch, onOpenSettings, onOpenMap, onOpenDiveComputer, onOpenEquipment, onOpenCommunity }: HeaderProps) {
  return (
    <header className="app-header">
      <div className="header-brand">
        <img src={pelagicIcon} alt="Pelagic" className="header-logo" style={{ width: 24, height: 24, borderRadius: 5 }} />
        <h1>Pelagic</h1>
      </div>
      
      <div className="header-actions">
        <button id="search-btn" className="header-btn header-btn-search" title={`Search (${modKey}+K)`} onClick={onOpenSearch}>
          <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
            <path d="M15.5 14h-.79l-.28-.27C15.41 12.59 16 11.11 16 9.5 16 5.91 13.09 3 9.5 3S3 5.91 3 9.5 5.91 16 9.5 16c1.61 0 3.09-.59 4.23-1.57l.27.28v.79l5 4.99L20.49 19l-4.99-5zm-6 0C7.01 14 5 11.99 5 9.5S7.01 5 9.5 5 14 7.01 14 9.5 11.99 14 9.5 14z"/>
          </svg>
          <span>Search</span>
          <kbd className="header-kbd">{modKey}+K</kbd>
        </button>
        ...
        <button className="header-btn" id="community-btn" title="Community" onClick={onOpenCommunity}>
          <svg viewBox="0 0 24 24" fill="currentColor" width="18" height="18">
